...
void test_DirectGraph_DFS_walk(){
    ...
    */
    ...
    std::vector<std::string> expected_DFS_post_order={"D","B","E","C","A","G","F"};
...
void test_DirectGraph_BFS_walk(){
    ...
    */
    ...
    std::vector<std::string> expected_BFS_pre_order={"F","A","G","B","C","D","E"};
    assert(expected_BFS_pre_order == visit_order);
    
    visit_order.clear();
    gt::Walk(gt::WalkAlgo::BFS_POSTORDER, &g,false,func);
    std::vector<std::string> expected_BFS_post_order={"E","D","C","B","G","A","F"};
...
void test_UndirectGraph_DFS_walk(){
    ...
    */
    ...
    std::vector<std::string> expected_DFS_pre_order1={"A","B","D","E","C","F","G"};
    std::vector<std::string> expected_DFS_pre_order2={"F","G","A","B","D","E","C"};
    assert(expected_DFS_pre_order1  == visit_order ||expected_DFS_pre_order2 == visit_order);
    
    visit_order.clear();
    gt::Walk(gt::WalkAlgo::DFS_POSTORDER, &g,false,func,{&data[0],&data[5]});
    std::vector<std::string> expected_DFS_post_order1={"C","E","D","B","A","G","F"};
    std::vector<std::string> expected_DFS_post_order2={"G","F","C","E","D","B","A"};
    assert(expected_DFS_post_order1 == visit_order || expected_DFS_post_order2 == visit_order);
}
...
void test_UndirectGraph_BFS_walk(){
    ...
    */
    ...
    std::vector<std::string> expected_BFS_pre_order={"A","F","B","C","G","D","E"};
    assert(expected_BFS_pre_order == visit_order);
    
    visit_order.clear();
    gt::Walk(gt::WalkAlgo::BFS_POSTORDER, &g,false,func,{&data[0],&data[5]});
    std::vector<std::string> expected_BFS_post_order={"E","D","G","C","B","F","A"};
    assert(expected_BFS_post_order == visit_order);
